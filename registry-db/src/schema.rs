...
diesel::table! {
    ...
    org (id) {
        ...
        /// (Automatically generated by Diesel.)
        gh_id -> Int4,
        /// The `gh_avatar` column of the `org` table.
        ///
        /// Its SQL type is `Varchar`.
        ///
        /// (Automatically generated by Diesel.)
...
diesel::table! {
    /// Representation of the `org_invitation` table.
    ///
    /// (Automatically generated by Diesel.)
    org_invitation (id) {
        /// The `id` column of the `org_invitation` table.
        ///
        /// Its SQL type is `Int8`.
        ///
        /// (Automatically generated by Diesel.)
        id -> Int8,
        /// The `org_id` column of the `org_invitation` table.
        ///
        /// Its SQL type is `Int8`.
        ///
        /// (Automatically generated by Diesel.)
        org_id -> Int8,
        /// The `invited_by_user_id` column of the `org_invitation` table.
        ///
        /// Its SQL type is `Int8`.
        ///
        /// (Automatically generated by Diesel.)
        invited_by_user_id -> Int8,
        /// The `created_at` column of the `org_invitation` table.
        ///
        /// Its SQL type is `Timestamptz`.
        ///
        /// (Automatically generated by Diesel.)
        created_at -> Timestamptz,
        /// The `accepted_at` column of the `org_invitation` table.
        ///
        /// Its SQL type is `Nullable<Timestamptz>`.
        ///
        /// (Automatically generated by Diesel.)
        accepted_at -> Nullable<Timestamptz>,
        /// The `revoked_at` column of the `org_invitation` table.
        ///
        /// Its SQL type is `Nullable<Timestamptz>`.
        ///
        /// (Automatically generated by Diesel.)
...
diesel::table! {
    /// A user_favourite represents a package that a user has marked as a favorite.
    user_favourite (user_id, package_id) {
        /// The `user_id` column of the `user_favourite` table.
        ///
        /// Its SQL type is `Int8`.
        ///
        /// (Automatically generated by Diesel.)
        user_id -> Int8,
        /// The `package_id` column of the `user_favourite` table.
        ///
        /// Its SQL type is `Int8`.
        ///
        /// (Automatically generated by Diesel.)
...
diesel::table! {
    /// A user_favourite_org represents an organization that a user has marked as a favorite.
    user_favourite_org (user_id, org_id) {
        /// The `user_id` column of the `user_favourite_org` table.
        ///
        /// Its SQL type is `Int8`.
        ///
        /// (Automatically generated by Diesel.)
        user_id -> Int8,
        /// The `org_id` column of the `user_favourite_org` table.
        ///
        /// Its SQL type is `Int8`.
        ///
        /// (Automatically generated by Diesel.)
...
diesel::joinable!(org_invitation -> org (org_id));
diesel::joinable!(org_invitation -> users (invited_by_user_id));
...
diesel::joinable!(user_favourite -> package (package_id));
diesel::joinable!(user_favourite -> users (user_id));
diesel::joinable!(user_favourite_org -> org (org_id));
diesel::joinable!(user_favourite_org -> users (user_id));
